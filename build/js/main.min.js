...
/* harmony import */ var _modules_parallax_js__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_modules_parallax_js__WEBPACK_IMPORTED_MODULE_9__);
...
var container = document.getElementById('for-blur');
...
var updateParallax = function updateParallax() {
  parallaxItems.forEach(function (item) {
    var movement = item.dataset.movement ? item.dataset.movement : 1; // определяем коэффициент смещения по дата атрибуту

    // eslint-disable-next-line no-undef
    gsap.to(item, {
      // добавляем смещение через gsap
...
var svgs = document.querySelectorAll('.partners__icon-wrapper svg');
...
function arrangePartners() {
  if (howMany === 7) {
    ...
    elements[1].style = "transform: rotate(".concat(29, "deg);");
    icons[1].style = "transform: rotate(".concat(-29, "deg);");
    elements[2].style = "transform: rotate(".concat(58, "deg);");
    icons[2].style = "transform: rotate(".concat(-58, "deg);");
    elements[3].style = "transform: rotate(".concat(90, "deg);");
    icons[3].style = "transform: rotate(".concat(-90, "deg);");
    elements[4].style = "transform: rotate(".concat(122, "deg);");
    icons[4].style = "transform: rotate(".concat(-122, "deg);");
    elements[5].style = "transform: rotate(".concat(151, "deg);");
    icons[5].style = "transform: rotate(".concat(-151, "deg);");
