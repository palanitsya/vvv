...
var blocks = document.querySelectorAll('.page-section');
blocks.forEach(function (block, index) {
  if (index !== 0) {
    _gsap_min__WEBPACK_IMPORTED_MODULE_0__["gsap"].from(block, {
      opacity: 0,
      y: 150,
      duration: 1,
      scrollTrigger: {
        trigger: block,
        start: '150 bottom',
        // Анимация начинается при появлении блока внизу экрана
        end: 'center center',
        // Анимация заканчивается, когда центр блока достигает центра экрана
...
var generateTimeline = function generateTimeline() {
  ...
  sections.forEach(function (section) {
    var blocks = _gsap_min__WEBPACK_IMPORTED_MODULE_0__["gsap"].utils.toArray(section.querySelectorAll("[data-animation]")).sort(function (a, b) {
